...
--
-- Servidor: localhost
-- Tiempo de generación: 09-07-2019 a las 17:52:04
...
INSERT INTO `cb_ingresos` (`id`, `cuenta_1`, `cuenta_2`, `cuenta_3`, `cuenta_4`, `monto`, `fecha`, `tipo_cambio`, `documento_respaldo`, `idcb_beneficiario`, `descripcion_transaccion`, `tipo_ingreso`, `cantidad_cuentas_egreso`, `saldo_debe`, `idad_logs`, `estado`) VALUES
(1, 1, 5, 0, 0, '100.00', '2019-07-01', '6.97', 'BOLETA DEPOSITO', 2, 'PRUEBAAA', 'IN', 0, '0.00', 11, 'PE');
