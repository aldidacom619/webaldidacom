...
function Header()
{
    ...
    $this->Cell(80);
    // Título
    //$this->Cell(20,10,'RADIO PATRULLAS 110 Y BOMBEROS',1,0,'C');
    // Salto de línea
    $this->Ln(10);


    $this->Image('images/cabecera_fina2.jpg',15,4,250,18);
