...
<!-- /#INICIA CUERPO -->
    ...
    <div class="panel panel-default">
               ...
               <div class="modal-body">
                   ...
                   <form id="formularioingreso">
                     <div class="row"> 
                       <legend>Datos de Egreso</legend>
                        <div  class="alert alert-danger"  id="validaregreso" style="display: none;"></div>
                       ...
                       <div class="col-lg-4">
                        <div class="form-group"> 
                                 ...
                                 <input class="form-control" id="disponible" name="disponible" disabled="true">
                          </div>
                         <div class="form-group"> 
                              <label>FECHA</label>
                ...
                <button type="button" class="btn btn-primary" id = "guardaregreso" onclick='guardaregresos()'><span class="glyphicon glyphicon-floppy-disk"></span> Guardar</button>
            </div>
    </div>  
<!-- /#FIN CUERPO -->
</div>
